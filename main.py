...
if __name__ == '__main__':
    ...
    # from DPA_S_meta_attack import DPA_S
    from DPA_S_gradient_attack import DPA_S_gradient_attack
    from DPA_S import DPA_S
    from FMPA_S import FMPA_S
    from CPA import CPA
    from FedE_CPA import FedE_CPA
    ...
    if args.setting == 'DPA_S_gradient_attack':
        print('DPA_S_gradient_attack')
        print()
        learner = DPA_S_gradient_attack(args, all_data)
        if args.mode == 'train':
            learner.train()
        elif args.mode == 'test':
            learner.before_test_load()
    ...
    if args.setting == 'FedE_CPA':
        print('FedE_CPA')
        print()
        learner = FedE_CPA(args, all_data)
        if args.mode == 'train':
            learner.train()
        elif args.mode == 'test':
            learner.before_test_load()
